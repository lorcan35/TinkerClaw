...
describe("loginGeminiCliOAuth", () => {
  ...
  const ENV_KEYS = [
    "TINKERCLAW_GEMINI_OAUTH_CLIENT_ID",
    "TINKERCLAW_GEMINI_OAUTH_CLIENT_SECRET",
  ...
  beforeEach(() => {
    envSnapshot = Object.fromEntries(ENV_KEYS.map((key) => [key, process.env[key]]));
    process.env.TINKERCLAW_GEMINI_OAUTH_CLIENT_ID = "test-client-id.apps.googleusercontent.com";
    process.env.TINKERCLAW_GEMINI_OAUTH_CLIENT_SECRET = "GOCSPX-test-client-secret"; // pragma: allowlist secret
