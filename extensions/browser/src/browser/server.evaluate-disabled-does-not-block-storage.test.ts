...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.TINKERCLAW_GATEWAY_PORT;
    process.env.TINKERCLAW_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.TINKERCLAW_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.TINKERCLAW_GATEWAY_PASSWORD;
