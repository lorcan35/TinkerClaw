...
describe("gateway auth", () => {
  ...
  it("resolves token/password from OPENCLAW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          TINKERCLAW_GATEWAY_TOKEN: "env-token",
          TINKERCLAW_GATEWAY_PASSWORD: "env-password",
    ...
    expect(
      resolveGatewayAuth({
        authConfig: {
          ...
          password: "${TINKERCLAW_GATEWAY_PASSWORD}",
        },
        env: {
          TINKERCLAW_GATEWAY_TOKEN: "env-token",
          TINKERCLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides TINKERCLAW_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        TINKERCLAW_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
