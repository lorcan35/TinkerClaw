...
beforeAll(async () => {
  envSnapshot = captureEnv(["TINKERCLAW_GATEWAY_PORT", "TINKERCLAW_GATEWAY_TOKEN"]);
  ...
  process.env.TINKERCLAW_GATEWAY_PORT = String(gatewayPort);
  process.env.TINKERCLAW_GATEWAY_TOKEN = gatewayToken;
