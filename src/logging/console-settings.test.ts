...
beforeEach(() => {
  ...
  originalOpenClawTestConsole = process.env.TINKERCLAW_TEST_CONSOLE;
  process.env.TINKERCLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalOpenClawTestConsole === undefined) {
    delete process.env.TINKERCLAW_TEST_CONSOLE;
  } else {
    process.env.TINKERCLAW_TEST_CONSOLE = originalOpenClawTestConsole;
  }
