...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("TINKERCLAW_GATEWAY_TOKEN", "");
    vi.stubEnv("TINKERCLAW_GATEWAY_PASSWORD", "");
    vi.stubEnv("TINKERCLAW_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses TINKERCLAW_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          TINKERCLAW_GATEWAY_TOKEN: "new-token",
        },
