  ...
  return withEnvAsync(
    {
      ...
      TINKERCLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when TINKERCLAW_VERSION is not set", async () => {
    await expectSelfVersion(
      {
        TINKERCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("prefers TINKERCLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
        TINKERCLAW_VERSION: "9.9.9-cli",
        TINKERCLAW_SERVICE_VERSION: "2.4.6-service",
        npm_package_version: "1.0.0-package",
      },
      "9.9.9-cli",
  ...
  it("still prefers runtime VERSION over TINKERCLAW_SERVICE_VERSION when TINKERCLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        TINKERCLAW_VERSION: " ",
        TINKERCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when TINKERCLAW_VERSION and TINKERCLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        TINKERCLAW_VERSION: " ",
        TINKERCLAW_SERVICE_VERSION: "\t",
