...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.TINKERCLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.TINKERCLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.TINKERCLAW_WATCH_COMMAND),
